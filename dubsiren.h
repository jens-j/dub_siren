...
#define OSC_FREQ_SWEEP_MAX      (2 * OSC_FREQ_MAX) // this does not work
#define OSC_AMP_MAX             32767 // 16 bit signed
#define OSC_AMP                 2500
#define OSC_SWEEP_RATE_MAX      (OSC_FREQ_RANGE / 2.0) // change / s
...
#define FILTER_MIN              200.0 // lower leads to unstable filter due to coefficient rounding
...
#define FILTER_SWEEP_RATE_MAX   (FILTER_RANGE / 2.0) // change / s
